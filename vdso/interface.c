...
void (*ukplat_tlsp_exit)(unsigned long tlsp) = (void (*)(unsigned long))0x00000000001053f0ULL;

int (*uk_syscall_r_getpid)(void) = (int (*)(void))0x00000000001278a0ULL;
int (*uk_syscall_r_getppid)(void) = (int (*)(void))0x0000000000127b40ULL;
